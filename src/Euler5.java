				                ...
				                boolean answerFound = false;
						            while(answerFound == false) {
								                  if(i == factors.length){ //if every number in the array has been tested
											                  answerFound = true;
													                } else if(number % factors[i] == 0) { //see if our current number is divible by the given factor
																                i = i + 1; //if the our current number is a multiple of the given factor increase the value of i to test the next factor in the array 
																		              } else {
																				                       number = number + 1;
																						                        i = 0;
																									              }
